...
class SiteController extends BSFController
{
	...
	public function actionExportPdf()
	{
		...
		$mPDF1->Output('liste_sites.pdf', 'I');
	}
	...
	public function actionExportXls(){
		...
		$xls = new JPhpExcel('UTF-8', false, 'Liste des sites');
		$xls->addArray($data);
		$xls->generateXML('liste_sites');
	}
}
