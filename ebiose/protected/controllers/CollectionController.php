...
class CollectionController extends BSFController
{
	/**
	...
	public function actionExportCsv()
	{
		...
		$filename = 'liste_collections.csv';
	...
	public function actionExportPdf()
	{
		...
		$mPDF1->Output('liste_collections.pdf', 'I');
	}
	...
	public function actionExportXls(){
		...
		foreach($dataProvider as $prel){
			$data[]=array($prel->id, $prel->description);
		}
		Yii::import('application.extensions.phpexcel.JPhpExcel');
		$xls = new JPhpExcel('UTF-8', false, 'Liste des collections');
		$xls->addArray($data);
		$xls->generateXML('liste_collections');
	}
}
