...
class MachineController extends BSFController
{
	/**
	...
	public function actionExportPdf()
	{
		...
		$mPDF1->Output('liste_machines.pdf', 'I');
	}
	...
	public function actionExportXls(){
		...
		$xls = new JPhpExcel('UTF-8', false, 'Liste des machines');
		$xls->addArray($data);
		$xls->generateXML('liste_machines');
	}
}
