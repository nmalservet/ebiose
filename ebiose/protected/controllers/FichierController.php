...
class FichierController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Fichier');
	...
	{
		$model=new Fichier('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Fichier']))
			$model->attributes=$_GET['Fichier'];
	...
	{
		$model=Fichier::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='fichier-form')
		{
