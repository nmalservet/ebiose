...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'fonction_utilisateur_id'); ?>
		<?php echo $form->dropDownList($model,'fonction_utilisateur_id',FonctionUtilisateur::model()->getArraySelectList()); ?>
		<?php echo $form->error($model,'fonction_utilisateur_id'); ?>
	</div>
